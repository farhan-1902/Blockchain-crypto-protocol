...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'User1', amount = 1000)
...
# while(len(blockchain.chain) >= 1 and len(blockchain.nodes) > 0):
#     @app.route('/replace_auto', methods=['GET'])
#     def replace_auto():
#         is_chain_replaced = blockchain.replace_chain()
